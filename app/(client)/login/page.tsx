...
import { Lock, ArrowRight, Loader2, Mail, ShieldCheck, CheckCircle2, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
  ...
  function handleGoogleSignIn() {
    ...
    setError('');
    // Redirect directly to authentic Google OAuth endpoint
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-slate-100 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center z-10">
        ...
        <p className="mt-2 text-sm text-slate-400">
          New client?{' '}
          <Link href="/signup" className="font-semibold text-blue-400 hover:text-blue-300 underline underline-offset-4">
        ...
        <div className="bg-slate-800/80 backdrop-blur-md py-8 px-6 shadow-2xl sm:rounded-2xl sm:px-10 border border-slate-700/80">
            ...
            >
              {gmailLoading ? (
                <>
                  ...
                  <span>Connecting to Google Authentication...</span>
                </>
              ) : (
                <>
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-800 px-3 text-slate-400 font-medium tracking-wider">Or sign in manually</span>
            </div>
          </div>
          ...
          <form className="mt-6 space-y-5" onSubmit={handleManualSubmit}>
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <Link href="/reset-password" className="text-xs font-extrabold text-blue-400 hover:text-blue-300 underline underline-offset-2 transition">
                  Forgot Password?
                </Link>
              </div>
          ...
          <div className="mt-8 border-t border-slate-700/80 pt-6">
            <div className="flex items-center gap-2 text-slate-400 text-xs justify-center">
              ...
              <span>GDFAS TLS 1.3 256-bit Encrypted Client Connection</span>
            </div>
          </div>
